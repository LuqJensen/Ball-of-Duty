...
import application.engine.game_object.components.physics.CollisionHandler;
...
public class Body
{
     ...
     * 
     * @param collection
     *            The other objects to check for collision
     * @param x
     *            The x value of the specified square to set the point within.
     * @param y
     *            The y value of the specified square to set the point within.
     * @param width
     *            The width value of the specified square to set the point within.
     * @param height
     *            The height value of the specified square to set the point within.
     */
    ...
    public boolean collidingWith(Collection<GameObject> gameObjects)
    {
        for (GameObject other : gameObjects)
        {
            ...
            {
                if (CollisionHandler.isColliding(this, other.getBody()))
                {
                    return true;
                }
            }
